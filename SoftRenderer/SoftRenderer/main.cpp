...
const TCHAR szName[] = TEXT("windows");
HDC hdc, dibDC;
...
void initDIB(HDC dibDC, int width, int height) 
{
	...
	screenDIB = CreateDIBSection(NULL, &bmi, DIB_RGB_COLORS, (void**)&_pScreenBits, NULL, 0);
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PSTR szCmdLine, int iCmdShow)
{
	...
	hWnd = CreateWindow(szName, TEXT("Software Render"), WS_OVERLAPPEDWINDOW,
